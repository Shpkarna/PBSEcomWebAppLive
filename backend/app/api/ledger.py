...
from app.data.repository_providers import get_ledger_repository
...
async def add_ledger_entry(
    ...
    stored = repo.add_entry(entry_dict)
    return LedgerEntryResponse(**stored)
...
async def get_ledger_entries(
    ...
    entries = repo.list_entries(category=category, start_date=sd, end_date=ed)
