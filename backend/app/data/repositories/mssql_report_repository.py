"""SQL Server-backed report repository (Phase 7)."""
...
class MSSQLReportRepository(MSSQLRepositoryBase, ReportRepository):
    """SQL Server implementation for reporting and analytics reads."""
