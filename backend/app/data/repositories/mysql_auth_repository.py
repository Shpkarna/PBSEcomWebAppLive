"""MySQL-backed auth repository implementation."""
...
class MySQLAuthRepository(MySQLRepositoryBase, AuthRepository):
    """MySQL implementation for auth persistence operations."""
